...
<%
    ...
    List<Usercomment> allComment = (List<Usercomment>) s.getAttribute("allComment");
                        ...
                        <div class="panel-body">
                            <div  class="dataTables_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
<%
        for (Usercomment comment : allComment){
%>
                                        <tr>
                                            <td><%=comment.getCommentId()%></td>
                                            <td><%=comment.getUsername() %></td>
                                            <td><%=df.format(comment.getCommentTime().getTime())%></td>
                                            <td><%=comment.getCommentWord() %></td>
                                            <td><%=comment.getReportTimes() %></td>
                                            <td>
                                                <input type="hidden" class="commentId" value="<%=comment.getCommentId()%>"/>
                                                <button class="btn btn-default deleteComment">点击删除评论</button>
                                            </td>
                                        </tr>
<%
        }
