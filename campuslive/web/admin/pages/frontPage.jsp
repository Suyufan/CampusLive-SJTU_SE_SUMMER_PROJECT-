...
<div id="wrapper">
    ...
    <%
        List<Activity> adminFrontPage = (List<Activity>) s.getAttribute("adminFrontPage");
        List<Activity> noneFrontPage = (List<Activity>) s.getAttribute("noneFrontPage");
    %>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">管理首页滚动条目</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <form action="addFrontPage" method="post">
                                    <div class="col-lg-6">
                                        <select name="actId" class="form-control">
                                            <%
                                                for(Activity activity : noneFrontPage){
                                            %>
                                    ...
                                    <button class="btn btn-default" type="submit">添加滚动条目</button>
                                </form>
                            </div>
                        </div>
                        <div class="panel-body">
                            <div  class="dataTables_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <%
                                        for (Activity activity : adminFrontPage){
                                    %>
                                    <tr>
                                        <td><img src="<%=activity.getPostPath() %>" style="height: 250px; width: 400px;"></td>
                                        <td><%=activity.getActId() %></td>
                                        <td><%=activity.getActName() %></td>
                                        <td>
                                            <input type="hidden" value="<%=activity.getActId() %>" class="actId">
