...
<%@ page import="Entity.Actmem" %>
<%@ page import="Recommand.Point" %><%--
...
<%
    ...
    List<Actmem> clusterMember = (List<Actmem>) s.getAttribute("clusterMember");
    List<Point> finalP = (List<Point>) s.getAttribute("finalP");
%>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div id="bubblePic" style="width: 700px; height: 600px">
...
<script type="text/javascript">
    var myChart = echarts.init(document.getElementById('bubblePic'));

    var data = [
        [
                <%
                for (Actmem actmem : clusterMember){
                %>
                [<%=actmem.getActId()%>, <%=actmem.getUserId()%>, 20000000, '用户操作', 1],
                <%
                }
                %>
        ],
        [
                ...
                for (Point p : finalP){
                %>
                [<%=p.getY() %>, <%=p.getX() %>, 2000000000, '逐步聚类', 2],
                <%
                }
                %>
        ]
