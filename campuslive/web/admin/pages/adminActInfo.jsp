...
<%
    ...
    List<User> members = (List<User>) s.getAttribute("members");
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">活动<%=activity.getActName() %>详情</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <img src="<%=activity.getPostPath() %>" alt="Activity Post" style="width: 550px;height: 500px"/>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <ul>
                                <li>活动名称：<%=activity.getActName()%></li>
                                <li>活动地点：<%=activity.getActLocation() %></li>
                                <li>主办人： <%=host.getUsername() %></li>
                                <li>当前人数：<%=activity.getCurrentMember()%>/<%=activity.getMaxMember()%></li>
                                <li>活动状态：
                                    <%
                                ...
                                <li>报名开始时间：<%=df.format(activity.getRegStartTime().getTime()) %></li>
                                <li>报名结束时间：<%=df.format(activity.getRegEndTime().getTime()) %></li>
                                <li>活动开始时间：<%=df.format(activity.getActStartTime().getTime()) %></li>
                                <li>活动结束时间：<%=df.format(activity.getActEndTime().getTime()) %></li>
                            </ul>
                        </div>
                    </div>
                </div>
